...
void Control::remote_a_isr() {
  ...
  switch (gateState) {
    ...
    case GateState::HALF_OPEN_FROM_CLOSED:
      ...
      break;
    case GateState::CLOSED: gateState = GateState::OPEN; break;
    case GateState::OPEN: gateState = GateState::CLOSED; break;
    default:
...
void Control::remote_b_isr() {
  ...
  switch (gateState) {
    case GateState::HALF_OPEN_FROM_OPEN:
    case GateState::HALF_OPEN_FROM_CLOSED: gateState = GateState::CLOSED; break;
    case GateState::CLOSED: gateState = GateState::HALF_OPEN_FROM_CLOSED; break;
    case GateState::OPEN: gateState = GateState::HALF_OPEN_FROM_OPEN; break;
    default: gateState = GateState::CLOSED; break;
  }
  float target = ((gateState == GateState::HALF_OPEN_FROM_OPEN) || (gateState == GateState::HALF_OPEN_FROM_CLOSED)) ? _Param::_HALF_OPEN : 0.0f;
  job::create_job(target);
}
